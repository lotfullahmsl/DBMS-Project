...
// // Get user information (Updated to include profile_picture)
...
//     try {
//         // Fetch current user data to verify password if updating
//         const [users] = await pool.query(
...
//         if (password) {
//             // If user signed up with Google, they can't update password this way
//             if (!user.password) {
